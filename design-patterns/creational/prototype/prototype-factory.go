...
var mainOffice = Employee{
	"", Address4{0, "123 East Dr", "London"}}
var auxOffice = Employee{
	"", Address4{0, "66 West Dr", "London"}}
...
func main4() {
	...
	//john := Employee{"John",
	//  Address4{100, "123 East Dr", "London"}}
	//
	//jane := john.DeepCopy()
	//jane.Name = "Jane"
	//jane.Office.Suite = 200
	//jane.Office.StreetAddress4 = "66 West Dr"
